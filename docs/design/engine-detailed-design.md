...
| HLA Component to Detailed Design | Started by this document; HLA-CONTRACT component draft created | Populate component-level DD sections/artifacts for all ten HLA components. |
